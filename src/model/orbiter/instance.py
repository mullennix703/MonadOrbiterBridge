# filepath: /new-python-project/new-python-project/src/model/orbiter/instance.py
import random
...
from .constants import SEPOLIA_EXPLORER_URL, SEPOLIA_RPC_URL, MONAD_SEPOLIA_ETHEREUM_ADDRESS
...
class Orbiter:
    ...
    async def wait_for_funds(self, initial_balance: int):
        ...
        max_attempts = 10000 # Convert total wait time to number of 10-second attempts
